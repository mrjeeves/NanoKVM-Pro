...
export const Settings = () => {
  ...
  // The Update tab installs OUR firmware from OUR release channel (see ./update
  // and the server's /api/application/update route), never cdn.sipeed.com — a
  // stock update would clobber our mesh server build. The old CDN-polling
  // "check for updates" nag on the gear is gone; the tab checks when opened.
  const tabs = [
