  ...
  translation: {
    ...
    settings: {
      ...
      device: {
        ...
        emmc: {
          warning: '注意',
          tip1: '第一次挂载 eMMC 会清除 CEC KVM 设备中 /data 目录下的所有数据，在操作前请备份数据。',
          tip2: '是否要继续进行挂载？'
        },
        network: '虚拟网卡',
      ...
      kvmadmin: {
        ...
        uninstall: '卸载',
        attention: '注意',
        confirmUninstall: '确定要卸载 CEC KVM Admin 吗？',
