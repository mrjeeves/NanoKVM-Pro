  ...
  translation: {
    ...
    settings: {
      ...
      device: {
        ...
        emmc: {
          warning: 'Warning',
          tip1: "Mounting the eMMC for the first time will wipe all data in the CEC KVM's /data directory. Please ensure you have a backup before proceeding.",
      ...
      kvmadmin: {
        title: 'CEC KVM Admin',
        description: 'Batch management of CEC KVM devices',
        ...
        uninstall: 'Uninstall',
        attention: 'Attention',
        confirmUninstall: 'Are you sure to uninstall CEC KVM Admin?',
