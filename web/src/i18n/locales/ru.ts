  ...
  translation: {
    ...
    settings: {
      ...
      device: {
        ...
        emmc: {
          warning: 'Внимание',
          tip1: "Монтирование eMMC в первый раз удалить все данные в папке /data на AllMyKVM's. Пожалуйста, перед продолжением убедитесь в наличии резервной копии.",
      ...
      kvmadmin: {
        ...
        description: 'Пакетное управление устройствами AllMyKVM',
        ...
        uninstall: 'Удалить',
        attention: 'Внимание',
        confirmUninstall: 'Вы уверены, что хотите удалить AllMyKVM Admin?',
