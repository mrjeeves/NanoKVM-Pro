  ...
  translation: {
    ...
    settings: {
      ...
      device: {
        ...
        emmc: {
          warning: 'Внимание',
          tip1: "Монтирование eMMC в первый раз удалить все данные в папке /data на CEC KVM's. Пожалуйста, перед продолжением убедитесь в наличии резервной копии.",
      ...
      kvmadmin: {
        title: 'CEC KVM Admin',
        description: 'Пакетное управление устройствами CEC KVM',
        ...
        uninstall: 'Удалить',
        attention: 'Внимание',
        confirmUninstall: 'Вы уверены, что хотите удалить CEC KVM Admin?',
